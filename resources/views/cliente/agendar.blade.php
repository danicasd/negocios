                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="comentarios"
                                          rows="5"
                                          class="w-full rounded-xl border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                                          placeholder="Ej. El problema está en el baño principal, favor de traer herramienta para tubería."></textarea>
                            </div>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 h-fit">
                    ...
                    <div class="space-y-5 text-sm">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-900">Reparación de fugas</p>
                        </div>

                        <div>
                            <p class="text-gray-500">Dirección</p>
                            <p class="font-semibold text-gray-900">
                                Av. Universidad 3000, Copilco Universidad
                            </p>
                        </div>

                        <div>
                            <p class="text-gray-500">Fecha</p>
                            <p id="resumen-fecha" class="font-semibold text-gray-900">Selecciona una fecha</p>
                        </div>

                        <div>
                            <p class="text-gray-500">Hora</p>
                            <p id="resumen-hora" class="font-semibold text-gray-900">10:00 AM</p>
                        </div>
                    ...
                    <div class="mt-10 pt-6 border-t border-gray-100 flex items-center justify-between">
                        <a href="{{ route('cliente.direccion') }}"
                            class="text-base text-blue-600 hover:text-blue-700 font-medium font-semibold transition font-medium">
                                Volver
                        </a>
