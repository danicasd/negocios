<x-app-layout>
    <div class="min-h-screen bg-gray-50 py-12">
        <div class="max-w-6xl mx-auto px-6">
            ...
            <form action="{{ route('cliente.cotizar.guardar', $servicio->id) }}" method="POST">
                @csrf
                    ...
                    <div class="lg:col-span-2 bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div class="mb-8">
                            ...
                            <p class="text-gray-500 mt-1">
                                Precio base:
                                $<span id="precio-base">{{ number_format($servicio->base_price, 2) }}</span>
                            </p>
                        </div>
    ...
    <script>
        const precioBase = {{ $servicio->base_price }};
